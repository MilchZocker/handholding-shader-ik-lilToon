...
namespace lilToon
{
    public class FakeArmV2Inspector : lilToonInspector
    {
        // Custom properties
        ...
        MaterialProperty shaderIKIntensityMin;
        MaterialProperty shaderIKIntensityMax;
        MaterialProperty vertexScale;
        MaterialProperty isLeftArm;
        
        private static bool isShowCustomProperties;
        private const string shaderName = "lilToonFakeArmV2";
        
        protected override void LoadCustomProperties(MaterialProperty[] props, Material material)
        {
            isCustomShader = true;
            ReplaceToCustomShaders();
            isShowRenderMode = true; // allow selecting render mode if needed
            ...
            shaderIKIntensityMin = FindProperty("_ShaderIKIntensityMin", props);
            shaderIKIntensityMax = FindProperty("_ShaderIKIntensityMax", props);
        ...
        protected override void DrawCustomProperties(Material material)
        {
            ...
            if(isShowCustomProperties)
            {
                ...
                if (shaderIKTargetLightIntensity != null)
                    m_MaterialEditor.ShaderProperty(shaderIKTargetLightIntensity, "Target Light Intensity (to Exclude)");
                
                if (shaderIKIntensityMin != null && shaderIKIntensityMax != null)
                {
                    EditorGUILayout.LabelField("Accepted Light Intensity Range");
                    float minValue = shaderIKIntensityMin.floatValue;
                    float maxValue = shaderIKIntensityMax.floatValue;
                    ...
                    shaderIKIntensityMin.floatValue = Mathf.Clamp(minValue, 0.0f, maxValue);
                    shaderIKIntensityMax.floatValue = Mathf.Clamp(maxValue, minValue, 1.0f);
                }
