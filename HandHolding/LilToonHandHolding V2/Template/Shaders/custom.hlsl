//----------------------------------------------------------------------------------------------------------------------
// Includes
#include "Assets/HandHolding/handholding-shader-ik-master/Assets/HaiHandholdingShaderIK/HaiHandholdingShaderIK V2.cginc"
...
#define LIL_CUSTOM_PROPERTIES \
    ...
    float _ShaderIKIntensityMin; \
    float _ShaderIKIntensityMax; \
    float _VertexScale; \
    float _IsLeftArm;
...
float _ShaderIKTargetLightIntensity;
#endif
#ifndef _ShaderIKIntensityMin
float _ShaderIKIntensityMin;
#endif
#ifndef _ShaderIKIntensityMax
float _ShaderIKIntensityMax;
#endif
#ifndef _VertexScale
float _VertexScale;
...
#define LIL_CUSTOM_VERTEX_OS \
    ...
    positionOS = transformArm( \
        ...
        _ShaderIKIntensityMin, \
        _ShaderIKIntensityMax, \
        restPos, \
